...
function RoutesConfig($stateProvider, $urlRouterProvider) {
  ...
  .state('home', {
    url: '/',
    templateUrl: 'js/menu/templates/home.template.html'
  })

  // Premade list page
  .state('mainList', {
    url: '/categories',
    templateUrl: 'js/menu/templates/main-menu.template.html',
  ...
  .state('itemDetail', {
    url: '/items/{shortName}',
    templateUrl: 'js/menu/templates/item-detail.template.html',
